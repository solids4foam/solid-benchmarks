...
reset
set output 'nonLinearGeometryUpdatedLagrangian.verticalDisplacement.eps'
...
plot "nonLinearGeometryUpdatedLagrangian.verticalDisplacement.txt" u 1:($4*1000) w lp ls 1 title'Vertical displacment'
