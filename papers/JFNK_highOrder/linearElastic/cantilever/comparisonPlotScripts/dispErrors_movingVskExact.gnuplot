...
set output "cantilever_dispErrors_tet-struct_movingVskExact.pdf"
plot \
    (2e-6 * x**2)   w l ls 1 title "2^{nd} order", \
    (4e-8 * x**3)   w l ls 2 title "3^{rd} order", \
    ...
    movingFile("tet.struct.ho.N1.summary.txt") u ((4*(beamArea/$4)/3**0.5)**0.5*1e3):($5) w lp ls 111 notitle , \
    movingFile("tet.struct.ho.N1.summary.txt") u ((4*(beamArea/$4)/3**0.5)**0.5*1e3):($6) w lp ls 112 notitle , \
    movingFile("tet.struct.ho.N2.summary.txt") u ((4*(beamArea/$4)/3**0.5)**0.5*1e3):($5) w lp ls 121 notitle , \
    movingFile("tet.struct.ho.N2.summary.txt") u ((4*(beamArea/$4)/3**0.5)**0.5*1e3):($6) w lp ls 122 notitle , \
    movingFile("tet.struct.ho.N3.summary.txt") u ((4*(beamArea/$4)/3**0.5)**0.5*1e3):($5) w lp ls 131 notitle , \
    movingFile("tet.struct.ho.N3.summary.txt") u ((4*(beamArea/$4)/3**0.5)**0.5*1e3):($6) w lp ls 132 notitle

set output "cantilever_dispErrors_tet-unstruct_movingVskExact.pdf"
plot \
    (2e-6 * x**2)   w l ls 1 title "2^{nd} order", \
    (4e-8 * x**3)   w l ls 2 title "3^{rd} order", \
    ...
    movingFile("tet.unstruct.ho.N1.summary.txt") u ((4*(beamArea/$4)/3**0.5)**0.5*1e3):($5) w lp ls 111 notitle , \
    movingFile("tet.unstruct.ho.N1.summary.txt") u ((4*(beamArea/$4)/3**0.5)**0.5*1e3):($6) w lp ls 112 notitle , \
    movingFile("tet.unstruct.ho.N2.summary.txt") u ((4*(beamArea/$4)/3**0.5)**0.5*1e3):($5) w lp ls 121 notitle , \
    movingFile("tet.unstruct.ho.N2.summary.txt") u ((4*(beamArea/$4)/3**0.5)**0.5*1e3):($6) w lp ls 122 notitle , \
    movingFile("tet.unstruct.ho.N3.summary.txt") u ((4*(beamArea/$4)/3**0.5)**0.5*1e3):($5) w lp ls 131 notitle , \
    movingFile("tet.unstruct.ho.N3.summary.txt") u ((4*(beamArea/$4)/3**0.5)**0.5*1e3):($6) w lp ls 132 notitle