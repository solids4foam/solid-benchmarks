...
set output "cantilever_stressErrors_tet-struct_movingVskExact.pdf"
plot \
    (0.2 * x**1)  w l ls 1 title "1^{st} order", \
    ...
    movingFile("tet.struct.ho.N1.summary.txt") u ((4*(beamArea/$4)/3**0.5)**0.5*1e3):($7*1e-6) w lp ls 111 notitle , \
    movingFile("tet.struct.ho.N1.summary.txt") u ((4*(beamArea/$4)/3**0.5)**0.5*1e3):($8*1e-6) w lp ls 112 notitle , \
    movingFile("tet.struct.ho.N2.summary.txt") u ((4*(beamArea/$4)/3**0.5)**0.5*1e3):($7*1e-6) w lp ls 121 notitle , \
    movingFile("tet.struct.ho.N2.summary.txt") u ((4*(beamArea/$4)/3**0.5)**0.5*1e3):($8*1e-6) w lp ls 122 notitle

set output "cantilver_stressErrors_tet-unstruct_movingVskExact.pdf"
plot \
    (0.2 * x**1)  w l ls 1 title "1^{st} order", \
    (2e-3 * x**2)  w l ls 2 title "2^{nd} order", \
    ...
    movingFile("tet.unstruct.ho.N1.summary.txt") u ((4*(beamArea/$4)/3**0.5)**0.5*1e3):($7*1e-6) w lp ls 111 notitle , \
    movingFile("tet.unstruct.ho.N1.summary.txt") u ((4*(beamArea/$4)/3**0.5)**0.5*1e3):($8*1e-6) w lp ls 112 notitle , \
    movingFile("tet.unstruct.ho.N2.summary.txt") u ((4*(beamArea/$4)/3**0.5)**0.5*1e3):($7*1e-6) w lp ls 121 notitle , \
    movingFile("tet.unstruct.ho.N2.summary.txt") u ((4*(beamArea/$4)/3**0.5)**0.5*1e3):($8*1e-6) w lp ls 122 notitle
