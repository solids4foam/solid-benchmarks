...
set output "mms_2D_stressErrors_hex_struct_movingVskExact.pdf"
plot \
    ...
    movingFile("hex.struct.ho.N1.summary.txt") u ((1/$4)**0.5*1e3):($7) w lp ls 111 notitle, \
    movingFile("hex.struct.ho.N1.summary.txt") u ((1/$4)**0.5*1e3):($8) w lp ls 112 notitle, \
    movingFile("hex.struct.ho.N2.summary.txt") u ((1/$4)**0.5*1e3):($7) w lp ls 121 notitle, \
    movingFile("hex.struct.ho.N2.summary.txt") u ((1/$4)**0.5*1e3):($8) w lp ls 122 notitle, \
    movingFile("hex.struct.ho.N3.summary.txt") u ((1/$4)**0.5*1e3):($7) w lp ls 131 notitle, \
    movingFile("hex.struct.ho.N3.summary.txt") u ((1/$4)**0.5*1e3):($8) w lp ls 132 notitle

set output "mms_2D_stressErrors_ho-tet_struct_movingVskExact.pdf"
plot \
    (5e-3 * x)           w l ls 1 title "1^{st} order", \
    (0.35e-5 * x**2)     w l ls 2 title "2^{nd} order", \
    (0.2e-8 * x**3)      w l ls 3 title "3^{rd} order", \
    ...
    movingFile("tet.struct.ho.N1.summary.txt") u ((4*(1/$4)/3**0.5)**0.5*1e3):($7) w lp ls 111 notitle, \
    movingFile("tet.struct.ho.N1.summary.txt") u ((4*(1/$4)/3**0.5)**0.5*1e3):($8) w lp ls 112 notitle, \
    movingFile("tet.struct.ho.N2.summary.txt") u ((4*(1/$4)/3**0.5)**0.5*1e3):($7) w lp ls 121 notitle, \
    movingFile("tet.struct.ho.N2.summary.txt") u ((4*(1/$4)/3**0.5)**0.5*1e3):($8) w lp ls 122 notitle, \
    movingFile("tet.struct.ho.N3.summary.txt") u ((4*(1/$4)/3**0.5)**0.5*1e3):($7) w lp ls 131 notitle, \
    movingFile("tet.struct.ho.N3.summary.txt") u ((4*(1/$4)/3**0.5)**0.5*1e3):($8) w lp ls 132 notitle

set output "mms_2D_stressErrors_ho-tet_unstruct_v1_movingVskExact.pdf"
plot \
    (5e-3 * x)           w l ls 1 title "1^{st} order", \
    (0.35e-5 * x**2)     w l ls 2 title "2^{nd} order", \
    (0.2e-8 * x**3)      w l ls 3 title "3^{rd} order", \
    ...
    movingFile("tet.unstruct_v1.ho.N1.summary.txt") u ((4*(1/$4)/3**0.5)**0.5*1e3):($7) w lp ls 111 notitle, \
    movingFile("tet.unstruct_v1.ho.N1.summary.txt") u ((4*(1/$4)/3**0.5)**0.5*1e3):($8) w lp ls 112 notitle, \
    movingFile("tet.unstruct_v1.ho.N2.summary.txt") u ((4*(1/$4)/3**0.5)**0.5*1e3):($7) w lp ls 121 notitle, \
    movingFile("tet.unstruct_v1.ho.N2.summary.txt") u ((4*(1/$4)/3**0.5)**0.5*1e3):($8) w lp ls 122 notitle, \
    movingFile("tet.unstruct_v1.ho.N3.summary.txt") u ((4*(1/$4)/3**0.5)**0.5*1e3):($7) w lp ls 131 notitle, \
    movingFile("tet.unstruct_v1.ho.N3.summary.txt") u ((4*(1/$4)/3**0.5)**0.5*1e3):($8) w lp ls 132 notitle

set output "mms_2D_stressErrors_ho-tet_unstruct_v2_movingVskExact.pdf"
plot \
    (5e-3 * x)           w l ls 1 title "1^{st} order", \
    (0.35e-5 * x**2)     w l ls 2 title "2^{nd} order", \
    (0.2e-8 * x**3)      w l ls 3 title "3^{rd} order", \
    ...
    movingFile("tet.unstruct_v2.ho.N1.summary.txt") u ((4*(1/$4)/3**0.5)**0.5*1e3):($7) w lp ls 111 notitle, \
    movingFile("tet.unstruct_v2.ho.N1.summary.txt") u ((4*(1/$4)/3**0.5)**0.5*1e3):($8) w lp ls 112 notitle, \
    movingFile("tet.unstruct_v2.ho.N2.summary.txt") u ((4*(1/$4)/3**0.5)**0.5*1e3):($7) w lp ls 121 notitle, \
    movingFile("tet.unstruct_v2.ho.N2.summary.txt") u ((4*(1/$4)/3**0.5)**0.5*1e3):($8) w lp ls 122 notitle, \
    movingFile("tet.unstruct_v2.ho.N3.summary.txt") u ((4*(1/$4)/3**0.5)**0.5*1e3):($7) w lp ls 131 notitle, \
    movingFile("tet.unstruct_v2.ho.N3.summary.txt") u ((4*(1/$4)/3**0.5)**0.5*1e3):($8) w lp ls 132 notitle

set output "mms_2D_stressErrors_ho-poly_struct_movingVskExact.pdf"
plot \
    (5e-3 * x)           w l ls 1 title "1^{st} order", \
    (0.35e-5 * x**2)     w l ls 2 title "2^{nd} order", \
    (0.2e-8 * x**3)      w l ls 3 title "3^{rd} order", \
    ...
    movingFile("poly.struct.ho.N1.summary.txt") u ((4*(1/$4)/pi)**0.5*1e3):($7) w lp ls 111 notitle, \
    movingFile("poly.struct.ho.N1.summary.txt") u ((4*(1/$4)/pi)**0.5*1e3):($8) w lp ls 112 notitle, \
    movingFile("poly.struct.ho.N2.summary.txt") u ((4*(1/$4)/pi)**0.5*1e3):($7) w lp ls 121 notitle, \
    movingFile("poly.struct.ho.N2.summary.txt") u ((4*(1/$4)/pi)**0.5*1e3):($8) w lp ls 122 notitle, \
    movingFile("poly.struct.ho.N3.summary.txt") u ((4*(1/$4)/pi)**0.5*1e3):($7) w lp ls 131 notitle, \
    movingFile("poly.struct.ho.N3.summary.txt") u ((4*(1/$4)/pi)**0.5*1e3):($8) w lp ls 132 notitle
