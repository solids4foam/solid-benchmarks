...
plot \
    ...
    movingFile("hex.struct.ho.N1.summary.txt") u ((volume/$4)**(1.0/3.0)*1e3):($7*1e-6) w lp ls 111 notitle, \
    movingFile("hex.struct.ho.N1.summary.txt") u ((volume/$4)**(1.0/3.0)*1e3):($8*1e-6) w lp ls 112 notitle, \
    movingFile("hex.struct.ho.N2.summary.txt") u ((volume/$4)**(1.0/3.0)*1e3):($7*1e-6) w lp ls 121 notitle, \
    movingFile("hex.struct.ho.N2.summary.txt") u ((volume/$4)**(1.0/3.0)*1e3):($8*1e-6) w lp ls 122 notitle, \
    movingFile("hex.struct.ho.N3.summary.txt") u ((volume/$4)**(1.0/3.0)*1e3):($7*1e-6) w lp ls 131 notitle, \
    movingFile("hex.struct.ho.N3.summary.txt") u ((volume/$4)**(1.0/3.0)*1e3):($8*1e-6) w lp ls 132 notitle

set output "mms_3D_stressErrors_ho-tet_struct_movingVskExact.pdf"
plot \
    (2e-2 * x)  w l ls 1 title "1^{st} order", \
    (0.15e-3 * x**2) w l ls 2 title "2^{nd} order", \
    (0.4e-6 * x**3) w l ls 3 title "3^{rd} order", \
    ...
    movingFile("tet.struct.ho.N1.summary.txt") u ((8.48528*(volume/$4))**(1.0/3.0)*1e3):($7*1e-6) w lp ls 111 notitle, \
    movingFile("tet.struct.ho.N1.summary.txt") u ((8.48528*(volume/$4))**(1.0/3.0)*1e3):($8*1e-6) w lp ls 112 notitle, \
    movingFile("tet.struct.ho.N2.summary.txt") u ((8.48528*(volume/$4))**(1.0/3.0)*1e3):($7*1e-6) w lp ls 121 notitle, \
    movingFile("tet.struct.ho.N2.summary.txt") u ((8.48528*(volume/$4))**(1.0/3.0)*1e3):($8*1e-6) w lp ls 122 notitle, \
    movingFile("tet.struct.ho.N3.summary.txt") u ((8.48528*(volume/$4))**(1.0/3.0)*1e3):($7*1e-6) w lp ls 131 notitle, \
    movingFile("tet.struct.ho.N3.summary.txt") u ((8.48528*(volume/$4))**(1.0/3.0)*1e3):($8*1e-6) w lp ls 132 notitle

set output "mms_3D_stressErrors_ho-tet_unstruct_movingVskExact.pdf"
plot \
    (2e-2 * x)  w l ls 1 title "1^{st} order", \
    (0.15e-3 * x**2) w l ls 2 title "2^{nd} order", \
    (0.4e-6 * x**3) w l ls 3 title "3^{rd} order", \
...
set output "mms_3D_stressErrors_ho-poly_struct_movingVskExact.pdf"
plot \
    (2e-2 * x)  w l ls 1 title "1^{st} order", \
    (0.15e-3 * x**2) w l ls 2 title "2^{nd} order", \
    (0.4e-6 * x**3) w l ls 3 title "3^{rd} order", \
    ...
    movingFile("poly.struct.ho.N1.summary.txt") u ((6*(volume/$4)/pi)**(1.0/3.0)*1e3):($7*1e-6) w lp ls 111 notitle, \
    movingFile("poly.struct.ho.N1.summary.txt") u ((6*(volume/$4)/pi)**(1.0/3.0)*1e3):($8*1e-6) w lp ls 112 notitle, \
    movingFile("poly.struct.ho.N2.summary.txt") u ((6*(volume/$4)/pi)**(1.0/3.0)*1e3):($7*1e-6) w lp ls 121 notitle, \
    movingFile("poly.struct.ho.N2.summary.txt") u ((6*(volume/$4)/pi)**(1.0/3.0)*1e3):($8*1e-6) w lp ls 122 notitle, \
    movingFile("poly.struct.ho.N3.summary.txt") u ((6*(volume/$4)/pi)**(1.0/3.0)*1e3):($7*1e-6) w lp ls 131 notitle, \
    movingFile("poly.struct.ho.N3.summary.txt") u ((6*(volume/$4)/pi)**(1.0/3.0)*1e3):($8*1e-6) w lp ls 132 notitle
