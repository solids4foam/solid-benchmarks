...
// Define the points
Point(1) = {0, 0, 0, d};  // Point at the origin
Point(2) = {L, 0, 0, d};  // Along the x-axis
Point(3) = {L, L, 0, d};  // Along the xy-plane
Point(4) = {0, L, 0, d};  // Along the y-axis
Point(5) = {0, 0, L, d};  // Along the z-axis
Point(6) = {L, 0, L, d};  // Along the xz-plane
Point(7) = {L, L, L, d};  // Opposite corner of the cube
Point(8) = {0, L, L, d};  // Along the yz-plane
