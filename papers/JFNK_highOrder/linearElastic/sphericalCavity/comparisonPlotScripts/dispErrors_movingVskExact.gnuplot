...
#set xrange [25:85]
set output "sphericalCavity_dispErrors_tet_movingVskExact.pdf"
plot \
    ...
    movingFile("tet.unstruct.ho.N1.summary.txt") u ((8.48528*(volume/$4))**(1.0/3.0)*1e3):($5) w lp ls 111 notitle , \
    movingFile("tet.unstruct.ho.N1.summary.txt") u ((8.48528*(volume/$4))**(1.0/3.0)*1e3):($6) w lp ls 112 notitle , \
    movingFile("tet.unstruct.ho.N2.summary.txt") u ((8.48528*(volume/$4))**(1.0/3.0)*1e3):($5) w lp ls 121 notitle , \
    movingFile("tet.unstruct.ho.N2.summary.txt") u ((8.48528*(volume/$4))**(1.0/3.0)*1e3):($6) w lp ls 122 notitle , \
    movingFile("tet.unstruct.ho.N3.summary.txt") u ((8.48528*(volume/$4))**(1.0/3.0)*1e3):($5) w lp ls 131 notitle , \
    movingFile("tet.unstruct.ho.N3.summary.txt") u ((8.48528*(volume/$4))**(1.0/3.0)*1e3):($6) w lp ls 132 notitle

set output "sphericalCavity_dispErrors_poly_movingVskExact.pdf"
set xrange [15:80]
plot \
    (5e-12 * x**2)   w l ls 1 title "2^{nd} order",\
    (0.8e-14 * x**3) w l ls 2 title "3^{rd} order",\
    ...
    movingFile("poly.unstruct.ho.N1.summary.txt") u ((6*(volume/$4)/pi)**(1.0/3.0)*1e3):($5) w lp ls 111 notitle , \
    movingFile("poly.unstruct.ho.N1.summary.txt") u ((6*(volume/$4)/pi)**(1.0/3.0)*1e3):($6) w lp ls 112 notitle , \
    movingFile("poly.unstruct.ho.N2.summary.txt") u ((6*(volume/$4)/pi)**(1.0/3.0)*1e3):($5) w lp ls 121 notitle , \
    movingFile("poly.unstruct.ho.N2.summary.txt") u ((6*(volume/$4)/pi)**(1.0/3.0)*1e3):($6) w lp ls 122 notitle , \
    movingFile("poly.unstruct.ho.N3.summary.txt") u ((6*(volume/$4)/pi)**(1.0/3.0)*1e3):($5) w lp ls 131 notitle , \
    movingFile("poly.unstruct.ho.N3.summary.txt") u ((6*(volume/$4)/pi)**(1.0/3.0)*1e3):($6) w lp ls 132 notitle
