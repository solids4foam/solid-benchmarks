...
set output "sphericalCavity_dispEfficiency_tet_unstruct.pdf"
plot \
    "tet.unstruct.seg.summary.txt" u  2:($5*1e6) w lp ls 01 title"S4F_{seg}", \
    "tet.unstruct.hypre.summary.txt" u 2:($5*1e6) w lp ls 02 title "S4F_{snes}", \
...
set output "sphericalCavity_stressEfficiency_tet_unstruct.pdf"
plot \
    "tet.unstruct.seg.summary.txt" u  2:($7*1e-6) w lp ls 01 title"S4F_{seg}", \
    "tet.unstruct.hypre.summary.txt" u 2:($7*1e-6) w lp ls 02 title "S4F_{snes}", \
...
set output "sphericalCavity_dispEfficiency_poly_unstruct.pdf"
plot \
    "poly.unstruct.seg.summary.txt" u  2:($5*1e6) w lp ls 01 title"S4F_{seg}", \
    "poly.unstruct.hypre.summary.txt" u 2:($5*1e6) w lp ls 02 title "S4F_{snes}", \
    "poly.unstruct.ho.N1.summary.txt" u 2:($5*1e6) w lp ls 11  title "{/Times-Italic p}_{ }=1", \
    "poly.unstruct.ho.N2.summary.txt" u 2:($5*1e6) w lp ls 21  title "{/Times-Italic p}_{ }=2", \
    "poly.unstruct.ho.N3.summary.txt" u 2:($5*1e6) w lp ls 31  title "{/Times-Italic p}_{ }=3"

set output "sphericalCavity_stressEfficiency_poly_struct.pdf"
plot \
    "poly.unstruct.seg.summary.txt" u  2:($7*1e-6) w lp ls 01 title"S4F_{seg}", \
    "poly.unstruct.hypre.summary.txt" u 2:($7*1e-6) w lp ls 02 title "S4F_{snes}", \
    "poly.unstruct.ho.N1.summary.txt" u 2:($7*1e-6) w lp ls 11  title "{/Times-Italic p}_{ }=1", \
    "poly.unstruct.ho.N2.summary.txt" u 2:($7*1e-6) w lp ls 21  title "{/Times-Italic p}_{ }=2", \
    "poly.unstruct.ho.N3.summary.txt" u 2:($7*1e-6) w lp ls 31  title "{/Times-Italic p}_{ }=3"
