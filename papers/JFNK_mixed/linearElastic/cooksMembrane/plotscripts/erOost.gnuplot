...
set output "Oosterlee_Accuracy_AbsDiff.png"

set title "Oosterlee Accuracy — Absolute Difference"
...
plot \
    "Data/Oosterlee_Data/preprocessed/lu_stab_data_plot.dat" using ($1<192?$1:1/0):(abs($2-bijelona_last)) \
        with linespoints lw 2 lc rgb "blue" pt 7 title "LuFd AbsDiff", \
    "Data/Oosterlee_Data/preprocessed/no_fd_stab_data_plot.dat" using ($1<192?$1:1/0):(abs($2-bijelona_last)) \
        with linespoints lw 2 lc rgb "green" pt 9 title "LuNoFd AbsDiff", \
    "Data/Oosterlee_Data/preprocessed/split_stab_data_plot.dat" using ($1<192?$1:1/0):(abs($2-bijelona_last)) \
