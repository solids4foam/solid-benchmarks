...
set output "Mixed_Accuracy_AbsDiff.png"

set title "Mixed Accuracy — Absolute Difference"
...
plot \
    "Data/Mixed/preprocessed/lu_stab_data_plot.dat" using ($1<192?$1:1/0):(abs($2-bijelona_last)) \
        with linespoints lw 2 lc rgb "blue" pt 7 title "LuFd AbsDiff", \
    "Data/Mixed/preprocessed/no_fd_stab_data_plot.dat" using ($1<192?$1:1/0):(abs($2-bijelona_last)) \
        with linespoints lw 2 lc rgb "green" pt 9 title "LuNoFd AbsDiff", \
    "Data/Mixed/preprocessed/split_stab_data_plot.dat" using ($1<192?$1:1/0):(abs($2-bijelona_last)) \
