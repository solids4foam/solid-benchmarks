...
set output "RC_Accuracy_AbsDiff.png"

set title "Rhie Chow Accuracy — Absolute Difference"
...
plot \
    "Data/RC/preprocessed/lu_rc_data_plot.dat" using ($1<192?$1:1/0):(abs($2-bijelona_last)) \
        with linespoints lw 2 lc rgb "blue" pt 7 title "LuFd AbsDiff", \
    "Data/RC/preprocessed/no_fd_rc_data_plot.dat" using ($1<192?$1:1/0):(abs($2-bijelona_last)) \
        with linespoints lw 2 lc rgb "green" pt 9 title "LuNoFd AbsDiff", \
    "Data/RC/preprocessed/split_rc_data_plot.dat" using ($1<192?$1:1/0):(abs($2-bijelona_last)) \
