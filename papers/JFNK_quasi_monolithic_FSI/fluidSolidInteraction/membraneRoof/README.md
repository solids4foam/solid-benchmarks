...
- displacement of the solid interface centre point `(50 5 0)` versus time
...
To remove generated campaign directories, logs, PDFs, and local wmake scratch
files, run:
...
One useful quantity of interest is the membrane displacement at the roof centre
point. In this case it is recorded by the `solidPointDisplacement` function
object in `system/controlDict`.
