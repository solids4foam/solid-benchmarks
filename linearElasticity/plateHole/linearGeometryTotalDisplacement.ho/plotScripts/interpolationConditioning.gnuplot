...
plot \
    ...
    "hex.ho.N1.summary.txt" u ((area/$4)**0.5*1e3):($5*1e6) w lp ls 11  title "{/Times-Italic p}_{ }=1, n^+=10", \
    "hex.ho.N2.summary.txt" u ((area/$4)**0.5*1e3):($5*1e6) w lp ls 21  title "{/Times-Italic p}_{ }=2, n^+=10", \
