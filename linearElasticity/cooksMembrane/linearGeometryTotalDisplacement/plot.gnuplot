...
reset
set output 'linearGeometryTotalDisplacement.verticalDisplacement.eps'
...
plot "linearGeometryTotalDisplacement.verticalDisplacement.txt" u 1:4 w lp ls 1 title'Vertical displacment'
