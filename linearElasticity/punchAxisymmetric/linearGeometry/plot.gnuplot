...
plot "postProcessing/surfaces/1/Dx_foundationContact.raw" u ($1*1000):($4*1000) w lp ls 1 title"S4F",\
...
plot "postProcessing/surfaces/1/Dz_foundationContact.raw" u ($1*1000):($4*1000) w lp ls 1 title"S4F",\
...
plot "postProcessing/surfaces/1/slavePressure_cylinderContact_foundationContact.raw" u (1000*$1):($6*-1e-6) w lp ls 1 title"S4F",\
...
plot "postProcessing/surfaces/1/slaveShearTraction_cylinderContact_foundationContact.raw" u ($1*1000):($4*1e-6) w lp ls 1 title"S4F",\
